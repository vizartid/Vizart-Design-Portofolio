export const winningEdge = {
  ...
  features: [
    ...
    },
    {
      ...
      description: "My core strength lies in combining creative vision with precise technical execution. The result: digital products that are not only visually stunning but also flawlessly functional.",
      icon: "Bolt",
      color: "pink-500"
    },
    {
      title: "Impactful Solutions",
      description: "My goal is to create digital solutions that deliver measurable impact. From boosting engagement to improving operational efficiency, I help you achieve your objectives.",
      icon: "ChartBar",
      color: "yellow-500"
    }
  ]
