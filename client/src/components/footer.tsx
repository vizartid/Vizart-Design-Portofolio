...
export default function Footer() {
  return (
    <footer className="py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#f4f4f4' }}>
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li><a href="#" className="hover:text-charcoal transition-colors">Website Design</a></li>
              <li><a href="#" className="hover:text-charcoal transition-colors">Logo & Branding</a></li>
              <li><a href="#" className="hover:text-charcoal transition-colors">Pitch Decks</a></li>
              <li><a href="#" className="hover:text-charcoal transition-colors">Social Media</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-200">
          <p className="text-gray-600 text-sm mb-4 sm:mb-0">
            © 2024 Lander Studio. All rights reserved.
          </p>
          <div className="flex space-x-4">
            <a href="#" className="text-gray-600 hover:text-charcoal transition-colors">
